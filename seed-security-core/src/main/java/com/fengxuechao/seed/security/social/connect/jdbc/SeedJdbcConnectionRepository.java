 ...
 */
class SeedJdbcConnectionRepository implements ConnectionRepository {
    ...
    public SeedJdbcConnectionRepository(String userId, JdbcTemplate jdbcTemplate, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor, String tablePrefix) {
        this.userId = userId;
